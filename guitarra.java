...
// declaração da classe
  public class Guitarra {
      ...
      // Criação de construtor da classe Guitarra
      public Guitarra(
          ...
          public void setNumeroSerie(String numeroSerie) {
             ...
             public void setTipo(String madeira) {
                 this.madeira = madeira;
             }
             ...
             public static void main(String[] args)   {
                 //instanciamos uum objeto chamado "minhaGuitara" que será tipo Guitarra
                 //Os valores passados são usados pelo construtor da classe para criar 
                 //o objeto
                 Guitarra minhaGuitara = new Guitarra("01020304", "fender", "telecaster",
                                                      "elétrica", "mogno", 1500);
